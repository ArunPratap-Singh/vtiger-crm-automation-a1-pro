 ...
 */
public class InspectAllForms extends BaseClass{
    ...
    @Test
    public void inspectAll() throws InterruptedException, IOException, ParseException {
    	
    	ExtentTest test = report.createTest("inspectAll");
